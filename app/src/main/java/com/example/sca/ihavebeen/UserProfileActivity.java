...
public class UserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ParseQueryAdapter<ParseObject> adapter1 = new ParseQueryAdapter<ParseObject>(this, "Game");
        adapter1.setTextKey("Opponent_Name");
        adapter1.setTextKey("Opponent_Id");

        ListView listView = (ListView)findViewById(R.id.waitingOnYouListView);
